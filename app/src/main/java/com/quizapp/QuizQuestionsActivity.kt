...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun updateCountdownText() {
        var text_thoigian = findViewById<TextView>(R.id.text_thoigian)

        var minutes = ((timeLeft/1000)/60)
        var seconds = ((timeLeft/1000)%60)

        var timeFormat = String.format(Locale.getDefault(),"%02d:%02d",minutes,seconds)

        text_thoigian.setText(timeFormat)
